...
public class ItemAdapter2 extends RecyclerView.Adapter<ItemAdapter2.CustomViewHolder> {

    private ArrayList<RecipeItem2> arrayList;
    private Context context;

    public ItemAdapter2(ArrayList<RecipeItem2> arrayList, Context context) {
        this.arrayList = arrayList;
        this.context = context;
    }
    @NonNull
    @Override
    public ItemAdapter2.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.main_recipe_list_item, parent, false);
        final ItemAdapter2.CustomViewHolder holder = new ItemAdapter2.CustomViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(@NonNull ItemAdapter2.CustomViewHolder holder, int position) {
